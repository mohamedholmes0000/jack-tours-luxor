# Jack Tours Luxor MVP

Premium MVP website and admin CMS for Jack Tours Luxor, built with Next.js App Router, TypeScript, Tailwind CSS, Prisma, PostgreSQL, and NextAuth.
